...
import { IConsumerPlanInput, ISchedule, Schedule, MealPlan, defaultDeliveryDay, deliveryDay } from '../consumer/consumerPlanModel';
...
export interface ICartInput {
  ...
  readonly consumerPlan: IConsumerPlanInput
