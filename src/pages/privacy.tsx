  ...
  return (
    <>
      <Container maxWidth='lg' className={classes.page}>
        ...
        <br />
        <Typography variant='body1'>
          Orchid does not share payment information with third parties.
        </Typography>
        <br />
        <Typography variant='subtitle1'>
        ...
        <br />
        <Typography variant='body1'>
          From time to time, Orchid collects third-party email addresses or other contact information from our users and customers so that Orchid may send information to their friends and family on an as-requested basis. For example, Orchid collects email addresses when a customer provides us with that information so that we may send out Referral Coupons. We also require the same information when customers utilize certain functions such as “email this to a friend” features.
        </Typography>
        <br />
        <Typography variant='h5'>
        ...
        <br />
        <Typography variant='body1'>
          When you use our Sites, we gather web traffic information via “cookies”. Cookies are small pieces of digital information stored by your browser on your computer that tracks initial and returning visits, browsing patterns on our site, and products ordered and viewed. Our cookies do not contain personally identifying information, but they enable us to identify you as a repeat visitor and help us personalize your orchideats.com experience. You need to have cookies enabled on your computer in order to use our site.
        </Typography>
        <br />
        <Typography variant='subtitle1'>
          FLASH COOKIES
        ...
        <br />
        <Typography variant='body1'>
          Orchid, or third parties engaged by us, may use web beacons on some pages of this site. A web beacon (also known as a pixel tag or clear GIF) is a graphic image which is used to better understand the browsing patterns of visitors to the page.
        </Typography>
        <br />
        <Typography variant='subtitle1'>
          WEB BEACONS, PIXEL TAGS, AND 3RD PARTY COOKIES
        ...
        <Typography variant='body1'>
          ...
          <br />
          <br />
          WILL ORCHID DISCLOSE THE INFORMATION IT COLLECTS TO OUTSIDE PARTIES?
          <br />
          <br />
          Orchid shares information with third-party intermediaries for shipping and billing purposes and with other third-party intermediaries that provide a service for Orchid to help us operate our business, our Site, or administer activities on our behalf. These companies do not retain personal information or share it with any other parties. These companies may include Cybersource, United Parcel Service, Federal Express, Visa, Mastercard, Discover, American Express and others.
          <br />
          <br />
        ...
        <br />
        <Typography variant='body1'>
          Orchid only allows the participation of persons 14 years and older to be on a Orchid meal program. 
        </Typography>
        <br />
        <Typography variant='subtitle1'>
        ...
        <Typography variant='body1'>
          ...
          <br />
          <br />
          If a user wishes to subscribe to our newsletter, we ask only for an individual’s e-mail address. Out of respect for our users’ privacy, we provide a way to opt-out of these communications. Click here to unsubscribe to the Orchid newsletter.
        </Typography>
        <br />
        <Typography variant='subtitle1'>
          CORRECTIONS/UPDATES
