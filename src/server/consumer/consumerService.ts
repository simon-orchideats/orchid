...
// import { EConsumerPlan } from './../../consumer/consumerPlanModel';
...
export interface IConsumerService {
  ...
  updateAuth0MetaData: (userId: string, stripeCustomerId: string) =>  Promise<Response>
  // updateMyPlan: (
...
class ConsumerService implements IConsumerService {
  ...
  public async updateAuth0MetaData(userId: string, stripeCustomerId: string): Promise<Response> {
